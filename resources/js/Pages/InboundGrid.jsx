    ...
    if (inbounds.length === 0) {
        return (
            <div className="text-center text-gray-600 dark:text-gray-300 col-span-full flex flex-col items-center justify-center min-h-[200px]">
                ...
                <p className="mb-1">
                    To get started, upload a PDF through the upload page.
                </p>
                <p>Once uploaded, your summarized inbounds will appear here.</p>
                <p>
                    API: POST Form Request to /api/inbounds Fields: url, notes,
                    pdf, user_id
                </p>
            </div>
        );
                ...
                .map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Actions */}
                            <div className="flex flex-col sm:flex-row justify-end items-stretch sm:items-center gap-3 pt-4 border-t border-gray-200">
                                <button
                                    type="button"
                                    onClick={handleRegenerate}
                                    title="Regenerate Summary"
                                    className="w-full sm:w-auto inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 transition-colors"
                                ...
                                <button
                                    type="button"
                                    onClick={handleSave}
                                    className="w-full sm:w-auto inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                                >
                                    Save
                                </button>
                                <button
                                    ...
                                    className="w-full sm:w-auto inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors"
                                >
                                    Publish
                                </button>
                            </div>
